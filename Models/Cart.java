...
public class Cart {
    ...
    public Cart(Customer customer, List<Book> books, List<Vinyl> vinyls) {
        ...
        this.books = new ArrayList<>(books); // Create a new list to avoid modifying the original list
        this.vinyls = new ArrayList<>(vinyls); // Create a new list to avoid modifying the original list
        updateBookStock();
        updateVinylStock();
    }
